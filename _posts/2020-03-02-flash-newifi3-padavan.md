...
1. 初始化路由器，不联网登录路由器管理后台 ***192.168.99.1*** 设置登录密码；
2. 连接路由器LAN口，访问 ***192.168.99.1/newifi/ifiwen_hss.html*** ，激活`SSH`(回车后网页会出现*succss*,既代表激活成功)；
...
电脑上浏览器输入 ***192.168.1.1*** 进入**Breed Web 恢复控制台**了。
