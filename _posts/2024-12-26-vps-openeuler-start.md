...
> openEuler Embedded 的 CI 会归档最新的构建镜像。若希望快速获取可用的镜像，请访问 dailybuild 地址 ***121.36.84.172/dailybuild/EBS-openEuler-Mainline*** ，在 `dailybuild/EBS-openEuler-Mainline/openeuler-xxxx-xx-xx/embedded_img`{: .filepath} 中可以下载镜像。
{: .prompt-info }
